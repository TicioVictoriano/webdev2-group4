        	...
        	<c:if test="${project.completed == 1}">
	            <tr>
	                ...
	                <td style="font-size: 14px">
	                    <a href="#" class="d-block text-center" data-toggle="modal" data-target="#milestone-moda-${project.id}"><i class="fa fa-plus-circle"></i> add / view</a>

	                    <div class="modal fade" id="milestone-moda-${project.id}">
	                                    ...
	                                    <div class="card" style="margin-bottom: 0;">
	                                        <div class="card-header p-2">
	                                            <ul class="nav nav-pills">
	                                                <li class="nav-item"><a class="nav-link active" href="#add-mileston1${project.id}" data-toggle="tab"><i class="fa fa-plus-circle pr-2"></i> Add</a></li>
	                                                <li class="nav-item"><a class="nav-link" href="#in-progre${project.id}" data-toggle="tab">In progress</a></li>
	                                                <li class="nav-item"><a class="nav-link" href="#milestone-end${project.id}" data-toggle="tab">Finished</a></li>
	                                            </ul>
	                                        </div>

	                                        <div class="card-body">
	                                            <div class="tab-content">
	                                                <div class="active tab-pane" id="add-mileston1${project.id}">
	                                                ...
	                                                <div class="tab-pane" id="in-progre${project.id}">
	                                                                        ...
	                                                                        <div class="timeline-item">
	                                                                            ...
	                                                                            <div class="timeline-footer py-0 my-0">
	                                                                                <div class="form-group row py-0 my-0">
	                                                                                    <div class="form-group row py-0 my-0">
	                                                                                        <form action="/milestone" method="post" id="mlstone-updat${milestone.id}">
	                                                                                            <div class="custom-control custom-checkbox">
	                                                                                                <input type="hidden" name="milestone_id" value="${milestone.id}">
	                                                                                                <input type="hidden" name="operation" value="<%= Operations.UPDATE.ordinal() %>">
	                                                                                                <input class="custom-control-input" required onclick="document.getElementById('mlstone-updat${milestone.id}').submit(); return false;" type="checkbox" name="completed" id="customCheckbox${milestone.id}" value="1">
	                                                ...
	                                                <div class="tab-pane" id="milestone-end${project.id}">
	                                                    <div class="timeline timeline-inverse">
	                                                        <c:forEach var="milestone" items="${milestones}">
	                                                            <c:if test="${milestone.projects_id == project.getId()}">
	                                                                <c:if test="${milestone.completed == 1}">
	                ...
	                <td class="project-actions text-right">
	                    ...
	                    <div class="modal fade" id="edit-modal-sm${project.id}">
	                        <div class="modal-dialog modal-lg">
	                            <div class="modal-content">
	                                <div class="modal-header">
	                                    ...
	                                    <form class="form-horizontal text-left" action="/project" method="post">
	                                        ...
	                                        <div class="form-group row">
	                                            <div class="offset-sm-3 col-sm-9 custom-control custom-checkbox">
	                                                <input class="custom-control-input" type="checkbox" name="completed" id="customCheck0{project.id}" value="1" checked>
	                                                <label for="customCheck0{project.id}" class="custom-control-label">Mark as completed</label>
	                                            </div>
	                                        </div>
	                    ...
	                    <div class="btn-group btn-group-sm">
	                        <a href="#" class="btn btn-info btn-sm" data-toggle="modal" data-target="#edit-modal-sm${project.id}"><i class="fa fa-edit" style="color: #fff !important"></i></a>
